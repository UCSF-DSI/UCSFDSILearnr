...
***Food for thought***: Let's think about the *age* variable for a minute. Although there are decimals, all the values are rounded to one decimal point. Doesn't that mean that the values can only occur at specific intervals, which makes *age* discrete? There is a little gray area, and you do have to exercise judgement in determine which variable type makes the most sense in these types of scenarios. In the later lessons, you'll learn about the types of analyses you can apply to each variable type which will help you determine how to make that judgement.
...
In summary, to create ggplots, you'll need to first initialize it, and then you'll add layers based on what you need to visualize.
