...
-   In the 1950s, NASA hired people "computers" to do computing to help launch rockets into space.
...
quiz(
  ...
  question("Which of the following object names follow our styling recommendations?",
    ...
    answer("`bloodPressure`", message = "Not quite. This type of naming is called **camelCase**, and it's more commonly used for other programming languages. Although it is not recommended based on Hadley Wickham's style guide, ."),
