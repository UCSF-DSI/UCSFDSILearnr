...
If you are completing this module within RStudio, go ahead and download [this csv file](https://raw.githubusercontent.com/UCSF-DSI/UCSFDSILearnr/main/data/course_records.csv) (click link -\> *right click* -\> *Save As...*), and add it to your *data* folder in your project.
...
-   The *Week.X.Attendance* columns contain boolean values.

-   The *X.Assessment.Score* columns contain numeric (decimal) values.
...
# Select all columns in the first row
print(course_records[1, ])

# Select all rows in the second column
print(course_records[, 2])
...
-   Scored higher on the post assessment than pre assessment

-   Scored at least 0.8 on the post assessment

In addition, you'll need to apply a curve of 0.1 to both assessment prior to selecting students based on this criteria.

Write some code to store a vector with the names of "exceptional" students in an object called *top_performers*.

```{r KC3, exercise=TRUE, exercise.lines=10, exercise.setup="exercise_03bsetup"}
# YOUR WORK HERE

# Apply a curve of 0.1 to both assessments
