...
dir.create("data")
grades <- read.csv(url("https://raw.githubusercontent.com/UCSF-DSI/UCSFDSILearnr/main/data/course_records.csv"))
write.csv(grades, "data/course_records.csv", row.names=FALSE)
rm(list=ls())
```
