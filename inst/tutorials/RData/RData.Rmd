...
With a matrix, you can now work with 2-dimensional data. However, one of matrix's limitations (or feature depending on your perspective) is that all values must be the same type. In most cases, the data you're working with contains multiple types of values.
